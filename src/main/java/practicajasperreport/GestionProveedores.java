...
public class GestionProveedores extends javax.swing.JFrame {
    ...
    private void botonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAceptarActionPerformed
        ...
        if (dni.getText().matches("[0-9]+")==false || dni.getText().length()!=8) {

            dni.grabFocus();
            dni.setBackground(new Color(0xFF6666));

        }
        else {

            camposOk++;
            int numLetraDni = Integer.parseInt(dni.getText())%23;
            letraDni.setText( "" + "TRWAGMYFPDXBNJZSQVHLCKE".charAt(numLetraDni));
        ...
        if (compruebaCampoNum(codigo, 5)) {
            ...
            codigo.setBackground(new Color(0xFF6666));
            codigo.grabFocus();
        ...
        if (compruebaCampoSinNum(nombre)) {
            ...
            nombre.setBackground(new Color(0xFF6666));
            nombre.grabFocus();
        ...
        if (compruebaCampoSinNum(apellidos)) {
            ...
            apellidos.setBackground(new Color(0xFF6666));
            apellidos.grabFocus();
        ...
        if (direccion.getText().isBlank()) {
            ...
            direccion.setBackground(new Color(0xFF6666));
            direccion.grabFocus();
        ...
        if (compruebaCampoNum(codigoPostal, 5)) {
            ...
            codigoPostal.setBackground(new Color(0xFF6666));
            codigoPostal.grabFocus();

        }

        //Localidad

        if (compruebaCampoSinNum(localidad)) {

            camposOk++;
            localidad.setBackground(Color.WHITE);

        }
        else {

            localidad.setBackground(new Color(0xFF6666));
            localidad.grabFocus();
        ...
        if (compruebaCampoNum(telefono, 9)) {
            ...
            telefono.setBackground(new Color(0xFF6666));
            telefono.grabFocus();
        ...
        if (compruebaCampoNum(movil, 9)) {
            ...
            movil.setBackground(new Color(0xFF6666));
            movil.grabFocus();
        ...
        if (compruebaCampoNum(fax, 10)) {
            ...
            fax.setBackground(new Color(0xFF6666));
            fax.grabFocus();
        ...
        if (email.getText().matches("^[^@]+@[^@]+\\.[^@]+$")) {
            ...
            email.setBackground(new Color(0xFF6666));
            email.grabFocus();
        ...
        try {
            ...
            total.setBackground(new Color(0xFF6666));
            total.grabFocus();

        }

        // Comprobación todos los campos
        if (camposOk == 12) {

            JOptionPane.showConfirmDialog(this, "Todos los datos son correctos", "Datos guardados", JOptionPane.CLOSED_OPTION);
